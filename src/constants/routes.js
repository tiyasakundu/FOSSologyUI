...
const routes = {
  ...
  admin: {
    ...
    group: {
      ...
      manageGroupUsers: "/admin/group/manageGroupUsers",
    },
    users: {
      add: "/admin/users/add",
  ...
  browseUploads: {
    ...
    more: {
      ...
      exportLists: "/browseUploads/more/exportLists",
      licenseList: "/browseUploads/more/exportLists/licenseList",
      copyrightList: "/browseUploads/more/exportLists/copyrightList",
