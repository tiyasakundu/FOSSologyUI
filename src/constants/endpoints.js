...
const endpoints = {
  ...
  uploads: {
    ...
    updateById: (id) => withBase(`/uploads/${id}`),
    ...
    getItemTreeView: (uploadId, itemId) => withBase(`/uploads/${uploadId}/item/${itemId}/tree/view`),
    topItem: (uploadId) => withBase(`/uploads/${uploadId}/topitem`),
  ...
  jobs: {
    ...
    getLog: (jobId, queueId) => withBase(`/jobs/${jobId}/${queueId}/log`), 
    downloadLog: (jobId, queueId) => withBase(`/jobs/${jobId}/${queueId}/log/download`),
  ...
  license: {
    ...
    adminCandidateById: (id) => withBase(`/license/admincandidates/${id}`),
